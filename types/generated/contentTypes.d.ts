...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    BlogPage: Schema.Attribute.Component<'layout.page-info', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Descrption: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerMenu: Schema.Attribute.Component<'config.social-link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userprofile: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
  };
}
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    courseSection: Schema.Attribute.Component<'layout.course-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dynaminHome: Schema.Attribute.DynamicZone<
      ['layout.news-letter', 'layout.mission']
    >;
    hero: Schema.Attribute.Component<'layout.hero', false>;
    homeSeo: Schema.Attribute.Component<'seo-information.seo', true>;
    homeServices: Schema.Attribute.Component<'layout.services-preview', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    postSelection: Schema.Attribute.Component<'post.post-selection', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    menuItems: Schema.Attribute.Component<'layout.button', true>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured: Schema.Attribute.Media<'images' | 'files', true>;
    liked: Schema.Attribute.Relation<
      'manyToMany',
    ...
    premium: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo-information.seo', false>;
    slug: Schema.Attribute.UID<'Title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    Title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiSeoConfigSeoConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seoConfig: Schema.Attribute.Component<'seo-information.seo', false>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    likesBy: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
